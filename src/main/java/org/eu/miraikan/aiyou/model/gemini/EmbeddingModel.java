...
public class EmbeddingModel {
    ...
    public EmbeddingResponse embedContent(EmbeddingRequest embeddingRequest) throws Exception {
    ...
    public BatchEmbeddingResponse batchEmbedContents(BatchEmbeddingRequest batchEmbeddingRequest) throws Exception {
